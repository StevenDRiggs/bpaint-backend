...
ActiveRecord::Schema.define(version: 2021_04_18_111507) do
  ...
  create_table "packages", force: :cascade do |t|
    ...
    t.string "name", null: false
    t.string "privacy_mode", default: "PRIVATE", null: false
  end

  create_table "packages_users", id: false, force: :cascade do |t|
    t.bigint "package_id", null: false
    t.bigint "user_id", null: false
    t.index ["package_id"], name: "index_packages_users_on_package_id"
    t.index ["user_id"], name: "index_packages_users_on_user_id"
  end
